...
- This implementation operates on a finite field of integers 𝔽_f, defined by the prime modulo *f*. There is no efficiency gain or complexity reduction by using properties of polynomials, as the code was not designed for finite polynomial fields.
