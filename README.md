...
- This implementation operates on a finite field of integers ƒ*𝖿*, defined by the prime modulo *ƒ*. There is no efficiency gain or complexity reduction by using properties of polynomials, as the code was not designed for finite polynomial fields.
